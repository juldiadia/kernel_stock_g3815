...
static DEVICE_ATTR(poll_delay ,S_IRUGO | S_IWUSR | S_IWGRP, ultrasonic_poll_delay_show, ultrasonic_poll_delay_store);
static DEVICE_ATTR(enable ,S_IRUGO | S_IWUSR | S_IWGRP, ultrasonic_enable_show, ultrasonic_enable_store);
static DEVICE_ATTR(name,S_IRUGO | S_IWUSR | S_IWGRP, ultrasonic_name_show, NULL);
static DEVICE_ATTR(read,S_IRUGO | S_IWUSR | S_IWGRP, ultrasonic_read_show, NULL);
static DEVICE_ATTR(ver_check,S_IRUGO | S_IWUSR | S_IWGRP, ultrasonic_ver_check_show, NULL);
static DEVICE_ATTR(data,S_IRUGO | S_IWUSR | S_IWGRP, ultrasonic_data_show, ultrasonic_data_store);
