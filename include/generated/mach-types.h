...
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_LOGANRE
# endif
# define machine_is_loganre()	(machine_arch_type == MACH_TYPE_LOGANRE)
#else
# define machine_is_loganre()	(0)
#endif
